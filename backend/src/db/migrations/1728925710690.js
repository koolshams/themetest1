module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('sessions', 'studentId', {
        transaction,
      });

      await queryInterface.removeColumn('sessions', 'counselorId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('sessions', 'action_items', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('sessions', 'recording_link', {
        transaction,
      });
