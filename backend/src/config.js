...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '337936a931f1d866c101b700566c007d',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'themetest1 <app@flatlogic.app>',
  ...
  project_uuid: '9c2e802f-8760-40d8-8096-f38f009124ff',
  flHost:
...
config.pexelsQuery = 'connected network metaphor';
config.host =
