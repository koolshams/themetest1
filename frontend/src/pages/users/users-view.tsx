    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Sessions Counselor</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.sessions_counselor &&
                      Array.isArray(users.sessions_counselor) &&
                      users.sessions_counselor.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
                        ...
                        >
                          ...
                          <td data-label='recording_link'>
                            {item.recording_link}
                          </td>

                          <td data-label='action_items'>{item.action_items}</td>
              ...
              {!users?.sessions_counselor?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Sessions Student</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.sessions_student &&
                      Array.isArray(users.sessions_student) &&
                      users.sessions_student.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
